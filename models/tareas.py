...
class TareaModel(conexion.Model):
    ...
    # Relaciones vamos a relacionar las tablas  se debe respetar el mismo tipo de dato de la tabla que estamos haciendo la relacion
    # La clase foreign Key va en los argumentos adicionales (*args)
